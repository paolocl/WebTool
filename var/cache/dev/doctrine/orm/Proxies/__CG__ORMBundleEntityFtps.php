 ...
 */
class Ftps extends \ORMBundle\Entity\Ftps implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ORMBundle\\Entity\\Ftps' . "\0" . 'id', '' . "\0" . 'ORMBundle\\Entity\\Ftps' . "\0" . 'idHosts', '' . "\0" . 'ORMBundle\\Entity\\Ftps' . "\0" . 'idIps', '' . "\0" . 'ORMBundle\\Entity\\Ftps' . "\0" . 'user', '' . "\0" . 'ORMBundle\\Entity\\Ftps' . "\0" . 'password'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Ftps $proxy) {
