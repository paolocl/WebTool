 ...
 */
class Country extends \ORMBundle\Entity\Country implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ORMBundle\\Entity\\Country' . "\0" . 'id', '' . "\0" . 'ORMBundle\\Entity\\Country' . "\0" . 'value'];
        }
