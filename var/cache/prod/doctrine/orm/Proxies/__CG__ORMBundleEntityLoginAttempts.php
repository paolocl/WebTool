 ...
 */
class LoginAttempts extends \ORMBundle\Entity\LoginAttempts implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ORMBundle\\Entity\\LoginAttempts' . "\0" . 'id', '' . "\0" . 'ORMBundle\\Entity\\LoginAttempts' . "\0" . 'ipAddress', '' . "\0" . 'ORMBundle\\Entity\\LoginAttempts' . "\0" . 'login', '' . "\0" . 'ORMBundle\\Entity\\LoginAttempts' . "\0" . 'time'];
        }
